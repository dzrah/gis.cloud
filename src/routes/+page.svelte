<script>
	...
	const getCountry = async (latitude, longitude) => {
		const apiKey = 'f172151879664b5f9010b144ecf2dc31'; // OpenCage API key
...
<main
	class="flex h-screen w-screen flex-col items-center justify-center overflow-hidden bg-bg-img bg-cover bg-center"
>
	<div
